...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MarriageTypeRepository")
 */
class MarriageType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Marriage", mappedBy="MarriageType")
     */
    private $marriages;
    ...
    public function removeMarriage(Marriage $marriage): self
    {
        if ($this->marriages->contains($marriage)) {
            ...
            if ($marriage->getMarriageType() === $this) {
                $marriage->setMarriageType(null);
            }
        }
